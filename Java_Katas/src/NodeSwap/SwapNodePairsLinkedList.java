package NodeSwap;
// If you are given the head node in a linked list, write a method that swaps each pair of nodes in the list,
...
public class SwapNodePairsLinkedList {
    public static void nodeSwap(Node input){
